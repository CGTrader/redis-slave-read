    ...
    module Interface
      class Hiredis < Base
        COMMANDS = %w(
          ...
          rpushx sadd sadd? save scan scard script sdiff sdiffstore select set setbit setex setnx setrange shutdown sinter sinterstore sismember slaveof slowlog smembers smove sort spop srandmember srem
